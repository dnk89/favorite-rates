...
public class UpdateCurrenciesWorkerTests
{
    ...
    {
        var updateAt = new TimeSpan(10, 0, 0); // 10:00
        var now = new DateTimeOffset(2026, 3, 2, 8, 0, 0, TimeSpan.Zero); // 8:00
    ...
    {
        var updateAt = new TimeSpan(10, 0, 0); // 10:00
        var now = new DateTimeOffset(2026, 3, 2, 11, 0, 0, TimeSpan.Zero); // 11:00
        var expected = TimeSpan.FromHours(23); // Next day at 10:00
    ...
    {
        var updateAt = new TimeSpan(10, 0, 0); // 10:00
        var now = new DateTimeOffset(2026, 3, 2, 10, 0, 0, TimeSpan.Zero); // 10:00
